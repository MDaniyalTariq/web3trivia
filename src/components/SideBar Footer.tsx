            ...
            >
                <div className="mr-12">
                    ...
                    <div className="flex gap-3 mt-4">
                        <Link href="#" className="block font-sans text-sm antialiased font-medium leading-normal text-inherit opacity-80" onClick={handleClose}>
                            Dismiss
                        </Link>
                        <Link href="/dashboard/pricing" className="block font-sans text-sm antialiased font-medium leading-normal text-inherit">
                            Upgrade Now
                        </Link>
                    </div>
                </div>
