...
const Features = () => {
    return (
        <section className="relative">
            ...
            <div className="absolute inset-0 w-full h-full opacity-0 dark:opacity-20 ">
                <Image
                    src="/hero-bg.svg"
                    alt="Background"
                    fill
            ...
            <div className="page-wrapper ">
                ...
                <main className="bg-white dark:bg-black dark:bg-custom-radial">
                    <div className="absolute w-full lg:w-full inset-y-0 lg:right-0 hidden lg:block dark:hidden">
                        <span className="absolute left-4 bottom-12 w-24 h-24 rounded-3xl bg-blue-600 blur-xl opacity-80 dark:hidden" />
                        <span className="w-4/12 lg:w-2/12 aspect-square bg-gradient-to-tr from-blue-500 to-lightblue-400 absolute -top-5 lg:left-0 rounded-full skew-y-12 blur-2xl opacity-40 skew-x-12 rotate-90" />

                    </div>
                    <span className="w-5/12 lg:w-3/12 aspect-square bg-gradient-to-br from-blue-600 to-green-400 absolute -top-10 lg:right-4 rounded-full blur-3xl opacity-50 dark:hidden" />
                    ...
                    <div className="text-center py-12">
                        <div className="hidden lg:block">
                            <TypeAnimation
                                ...
                                wrapper="div"
                                speed={50}
                                className="text-4xl font-bold mt-8 gaming-effect"
                                repeat={Infinity}
                            />
                        </div>

                        <div className="text-3xl block font-bold mt-8 gaming-effect lg:hidden">
                            Engage with trivia questions, earn rewards
                        </div>
                    </div>
                    ...
                    <div data-w-id="14a70c8a-7dcd-2d5a-01d1-4592f5b44138"  >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="blurry-bg p-4 absolute -top-8 right-5 -mt-1 pt-10 z-50">
                                                    <Badge />
                                                </div>
                                            </div>
                                        </div>
